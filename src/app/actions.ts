...
1.  **Extraia os seguintes campos do texto:**
    ...
    -   'detractors': Na **página 5**, na seção 'Posição Detalhada dos Ativos', encontre e extraia uma lista com os ativos cuja rentabilidade em **%CDI** foi **inferior a 100%**. Para cada um, extraia o nome do ativo ('asset') e o percentual de retorno ('return').
