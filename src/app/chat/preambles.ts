...
2.  **Reconhecimento de Nome vs. Valor (REGRA CRÍTICA):** Em cada linha de ativo na seção "Posição Detalhada dos Ativos", o nome completo do ativo pode conter texto, hífens, datas e porcentagens (ex: "LCA BANCO ITAU - NOV/2025 - 93,00% CDI"). O valor da **rentabilidade do mês** é SEMPRE o último valor percentual na linha. Use este padrão para separar corretamente o 'asset' (o nome) do 'return' (a rentabilidade).
