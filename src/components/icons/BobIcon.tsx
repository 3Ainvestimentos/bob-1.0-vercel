...
export const BobIcon = ({ className, isThinking = false, hasError = false, isGreeting = false, ...props }: BobIconProps) => (
    <svg
        ...
        {...props}
    >
        <g className={cn(hasError && 'animate-shake')}>
            <g transform="translate(0, 1.5)" className={cn(isThinking && 'animate-pulse', isGreeting && 'animate-lamp-fade-in')}>
                {/* Lâmpada */}
