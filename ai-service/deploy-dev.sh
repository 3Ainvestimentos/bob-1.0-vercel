...
# ============================================
# DEPLOY SCRIPT - Bob AI Service para Cloud Run
# ============================================

set -e  # Parar em caso de erro

# Configurações
PROJECT_ID="bobv1-develop"  # ← SUBSTITUIR pelo seu projeto
SERVICE_NAME="bob-ai-service-dev"
REGION="us-central1" 
IMAGE_NAME="gcr.io/$PROJECT_ID/$SERVICE_NAME"

echo "🚀 Iniciando deploy do Bob AI Service..."
...
ALLOWED_ORIGINS_DEV="http://localhost:3000,http://localhost:3001,https://www.3arivaconnect.com.br,https://studio--datavisor-44i5m.us-central1.hosted.app,https://bob1-0.vercel.app,https://bob-1-0-backup.vercel.app,https://bob-1-0-backup-q5tl976x8-3-ariva.vercel.app,https://bob1-0-jve9aajkq-3-ariva.vercel.app"
...
gcloud run deploy $SERVICE_NAME \
    ...
    --set-env-vars "^@^ENVIRONMENT=development@ALLOWED_ORIGINS=${ALLOWED_ORIGINS_DEV}@FIREBASE_STORAGE_BUCKET=${PROJECT_ID}.firebasestorage.app" \
    --set-secrets "GOOGLE_API_KEY=${GOOGLE_SECRET_NAME}:latest,LANGCHAIN_API_KEY=${LANGCHAIN_SECRET_NAME}:latest,SERVICE_ACCOUNT_KEY_INTERNAL=${SERVICE_ACCOUNT_SECRET_NAME}:latest"
