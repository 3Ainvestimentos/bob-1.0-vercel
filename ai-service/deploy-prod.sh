...
ALLOWED_ORIGINS_PROD="http://localhost:3000,http://localhost:3001,https://www.3arivaconnect.com.br,https://studio--datavisor-44i5m.us-central1.hosted.app,https://bob-develop-3a.firebaseapp.com"
...
gcloud run deploy $SERVICE_NAME \
    ...
    --set-env-vars "^@^ENVIRONMENT=${ENVIRONMENT}@ALLOWED_ORIGINS=${ALLOWED_ORIGINS_PROD}" \
